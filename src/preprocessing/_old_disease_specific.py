#######################################
####   This is old code used    #######
#### to process disease specific ######
#### variants using OMIM and MedGen ###
############ databases.  ##############
#######################################
...
#                 id_idx += 1
#                 if np.sum(df_id['label']) >= 50 and np.sum(~df_id['label']) >= 50:
