...
from src.plots.plots_benchmark_mode import plot_metrics
from src.plots.plots_machine_learning import *
...
class Metapredictions(object):
    ...
    def __init__(self, df: pd.DataFrame,
                 ...
                 out_dir: str,
                 top_tools: dict,
                 missing_rate_allowed: float = 0.5,
        ...
        :param dict top_tools: Top 5 tools generated by the performance
        ...
        useless_cols = ['index', 'ref', 'alt', 'id', 'rsID', 'HGVSc']
        if all(c in df.columns for c in ['hg19.chr', 'hg19.pos']):
            useless_cols.extend(['hg19.chr', 'hg19.pos'])
        else:
            useless_cols.extend(['chr', 'pos'])
    ...
    def recursive_feature_elimination(self, trained_clfs: dict):
        ...
        for _name, _clf in trained_clfs.items():
            ...
            plot_rfecv(selector, 3, self.features,
