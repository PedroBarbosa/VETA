...
|                                 | labranchoR        | > 0.1                | Yes                       | model_inference |
...
* `conspliceml_like`- Process ConSpliceML-like predictions (`something|0.295`)into numeric scores. It does not require gene name to be in the first part of the string with a '|' separator.
